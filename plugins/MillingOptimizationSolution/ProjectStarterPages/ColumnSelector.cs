...
namespace Pavel.Plugins.ProjectStarterPages {
    ...
    /// <summary>
    /// This ProjectStarterPage allows the user to choose the Columns to be visualized.
    /// </summary>
    public partial class ColumnSelector : Pavel.GUI.ProjectStarterPage {
        ...
        /// <summary>
        /// Fills the list of MillingColumns in the MillingOptimizationUseCase.
        /// </summary>
        override public Boolean Execute() {
            ...
            (Pavel.Framework.ProjectController.Project.UseCase as MillingOptimizationUseCase).MillingColumns = visColumns;
            return true;
        }

        /// <summary>
        /// Clears the list of MillingColumns in the MillingOptimizationUseCase.
        /// </summary>
        override public void Undo() {
            (Pavel.Framework.ProjectController.Project.UseCase as MillingOptimizationUseCase).MillingColumns = null;
        }
