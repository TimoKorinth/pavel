...
namespace Pavel.Plugins.ProjectStarterPages {
    public partial class SimProfileOpener : Pavel.GUI.ProjectStarterPage {

        public SimProfileOpener() {
            InitializeComponent();
        }
        ...
        public override bool Execute() {
            ...
            foreach (object filename in this.profileList.Items) {
                using (StreamReader reader = new StreamReader(filename as string)) {
                    ...
                    ps.Label = "Sim Profile " + height.ToString();
            ...
            try {
                if (null != MillingSimulationUseCase.simulationPointSet) {
                    ...
                    MillingSimulationUseCase.simulationPointSet = null;
                }
